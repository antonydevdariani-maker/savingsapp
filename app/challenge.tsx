...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: "rgba(0,0,0,0.8)", borderWidth: 1, borderColor: "rgba(59,130,246,0.3)", borderRadius: 24, padding: 28, alignItems: "center", width: 300 },
  cardTitle: { color: "#3B82F6", fontSize: 12, letterSpacing: 2, marginBottom: 8 },
  ...
  instructionBox: { backgroundColor: "rgba(59,130,246,0.08)", borderRadius: 12, padding: 12, marginBottom: 20, width: "100%", gap: 4 },
  instructionText: { color: "rgba(255,255,255,0.7)", fontSize: 13, textAlign: "center" },
  startBtn: { backgroundColor: "#3B82F6", borderRadius: 14, paddingVertical: 16, width: "100%", alignItems: "center" },
  startBtnText: { color: "#FFFFFF", fontWeight: "700", fontSize: 16 },
  bottom: { position: "absolute", bottom: 0, left: 0, right: 0, backgroundColor: "rgba(0,0,0,0.85)", borderTopWidth: 1, borderTopColor: "#101A2C", padding: 20, paddingBottom: 48 },
  ...
  track: { height: 8, backgroundColor: "#101A2C", borderRadius: 4, overflow: "hidden", marginBottom: 14 },
  fill: { height: 8, backgroundColor: "#3B82F6", borderRadius: 4 },
  repBtn: { backgroundColor: "#3B82F6", borderRadius: 16, paddingVertical: 20, alignItems: "center", marginTop: 8 },
  repBtnText: { color: "#FFFFFF", fontWeight: "800", fontSize: 18 },
