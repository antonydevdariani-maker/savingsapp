...
const s = StyleSheet.create({
  ...
  balanceCard: { backgroundColor: "#121A2B", borderRadius: 16, padding: 16, borderWidth: 1, borderColor: "#1E2A40" },
  balLabel: { color: "rgba(255,255,255,0.4)", fontSize: 11 },
  balValue: { color: "#fff", fontWeight: "700", fontSize: 28, marginTop: 2 },
  lockBox: { backgroundColor: "#121A2B", borderRadius: 20, padding: 32, borderWidth: 1, borderColor: "rgba(248,113,113,0.3)", alignItems: "center", gap: 8, marginTop: 8 },
  ...
  inputWrap: { flexDirection: "row", alignItems: "center", backgroundColor: "#121A2B", borderWidth: 1, borderColor: "#1E2A40", borderRadius: 16, paddingHorizontal: 16 },
  ...
  challengeBox: { backgroundColor: "#121A2B", borderRadius: 14, padding: 16, borderWidth: 1, borderColor: "rgba(16,185,129,0.3)" },
  challengeLabel: { color: "rgba(255,255,255,0.4)", fontSize: 11 },
  challengeReps: { color: "#10B981", fontWeight: "800", fontSize: 28, marginTop: 2 },
  challengeSub: { color: "rgba(255,255,255,0.3)", fontSize: 12, marginTop: 4 },
  error: { color: "#f87171", fontSize: 13 },
  btn: { backgroundColor: "#10B981", borderRadius: 16, paddingVertical: 18, alignItems: "center", marginTop: "auto" },
