...
const s = StyleSheet.create({
  ...
  green: { color: "#00ff88" },
  tabs: { flexDirection: "row", backgroundColor: "#111", borderRadius: 12, padding: 4, marginBottom: 8 },
  ...
  btn: { backgroundColor: "#00ff88", borderRadius: 14, paddingVertical: 16, alignItems: "center", marginTop: 4 },
  btnText: { color: "#000", fontWeight: "700", fontSize: 16 },
  divider: { flexDirection: "row", alignItems: "center", gap: 10, marginVertical: 4 },
  line: { flex: 1, height: 1, backgroundColor: "#222" },
  dividerText: { color: "rgba(255,255,255,0.2)", fontSize: 13 },
  testBtn: { backgroundColor: "#1a1a1a", borderWidth: 1, borderColor: "#333", borderRadius: 14, paddingVertical: 16, alignItems: "center" },
