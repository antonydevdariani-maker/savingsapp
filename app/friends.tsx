...
const s = StyleSheet.create({
  ...
  input: { flex: 1, backgroundColor: "#121A2B", borderWidth: 1, borderColor: "#1E2A40", borderRadius: 14, paddingHorizontal: 16, paddingVertical: 14, color: "#fff", fontSize: 15 },
  addBtn: { backgroundColor: "#10B981", borderRadius: 14, paddingHorizontal: 22, justifyContent: "center" },
  ...
  card: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "#121A2B", borderRadius: 14, borderWidth: 1, borderColor: "#1E2A40", padding: 16, marginBottom: 8 },
  friendAvatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: "rgba(16,185,129,0.15)", alignItems: "center", justifyContent: "center" },
  friendAvatarText: { color: "#10B981", fontWeight: "700", fontSize: 15 },
  email: { color: "#fff", fontSize: 14, fontWeight: "500" },
  cardActions: { flexDirection: "row", gap: 8, marginLeft: "auto" },
  acceptBtn: { backgroundColor: "#10B981", borderRadius: 10, paddingHorizontal: 14, paddingVertical: 8 },
  acceptText: { color: "#FFFFFF", fontWeight: "700", fontSize: 13 },
  declineBtn: { backgroundColor: "#1A2438", borderRadius: 10, paddingHorizontal: 14, paddingVertical: 8 },
  ...
  emptyBox: { backgroundColor: "#121A2B", borderRadius: 14, borderWidth: 1, borderColor: "#1E2A40", padding: 24, alignItems: "center", marginBottom: 24 },
