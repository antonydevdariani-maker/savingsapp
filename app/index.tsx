...
const s = StyleSheet.create({
  ...
  green: { color: "#3B82F6" },
  navLink: { color: "#3B82F6", fontSize: 14, fontWeight: "600" },
  ...
  badgeText: { color: "#3B82F6", fontSize: 12, fontWeight: "600", letterSpacing: 0.3 },
  ...
  steps: { gap: 1, marginBottom: 40, backgroundColor: "#16233A", borderRadius: 20, overflow: "hidden" },
  step: {
    flexDirection: "row",
    alignItems: "center",
    gap: 18,
  ...
  stepNum: { fontSize: 13, fontWeight: "700", color: "rgba(59,130,246,0.5)", letterSpacing: 1 },
  stepBody: { flex: 1 },
