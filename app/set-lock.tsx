...
const s = StyleSheet.create({
  ...
  preset: { width: "47%", backgroundColor: "#121A2B", borderRadius: 14, padding: 16, borderWidth: 1, borderColor: "#1E2A40" },
  presetSelected: { borderColor: "#10B981", backgroundColor: "rgba(16,185,129,0.08)" },
  presetLabel: { color: "#fff", fontWeight: "700", fontSize: 16 },
  presetLabelSelected: { color: "#10B981" },
  presetDate: { color: "rgba(255,255,255,0.3)", fontSize: 11, marginTop: 4 },
  presetDateSelected: { color: "rgba(16,185,129,0.6)" },
